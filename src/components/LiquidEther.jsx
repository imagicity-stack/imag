...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container) {
        this.container = container;
        this.globalTarget = window;
        this.globalTarget.addEventListener('mousemove', this._onMouseMove, false);
        this.globalTarget.addEventListener('touchstart', this._onTouchStart, false);
        this.globalTarget.addEventListener('touchmove', this._onTouchMove, false);
        this.globalTarget.addEventListener('touchend', this._onTouchEnd, false);
      }
      dispose() {
        if (this.globalTarget) {
          this.globalTarget.removeEventListener('mousemove', this._onMouseMove, false);
          this.globalTarget.removeEventListener('touchstart', this._onTouchStart, false);
          this.globalTarget.removeEventListener('touchmove', this._onTouchMove, false);
          this.globalTarget.removeEventListener('touchend', this._onTouchEnd, false);
        }
        this.globalTarget = null;
        this.container = null;
      }
      setCoords(x, y) {
        ...
        const rect = this.container.getBoundingClientRect();
        this.isHoverInside = this.isInsideContainer(x, y);
      ...
      onDocumentMouseMove(event) {
        ...
        if (this.isAutoActive && !this.hasUserControl && !this.takeoverActive) {
          ...
          this.isAutoActive = false;
          this.isHoverInside = this.isInsideContainer(event.clientX, event.clientY);
          return;
        }
